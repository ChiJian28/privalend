...
function buildContract(name, dir) {
    console.log(`\n🔨 Building ${name}...`);
...
async function main() {
    ...
    const privalendWasm = buildContract("z-privalend", resolve(CONTRACTS_DIR, "privalend"));
    const consortiumWasm = buildContract("z-fraud-consortium", resolve(CONTRACTS_DIR, "fraud-consortium"));
    console.log("\n=====================================");
